...
{
    public class CannonPoolManager : Singleton<CannonPoolManager>
    {
        [SerializeField] private List<CannonPoolItem> ItemList;
        ...
        public GameObject GetObject(string key)
        {
            ...
            var _temp = ItemList.FirstOrDefault<CannonPoolItem>(x => x._name == key);
            if (_temp != null)
